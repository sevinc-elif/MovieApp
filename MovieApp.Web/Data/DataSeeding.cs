    ...
    public static class DataSeeding
    {
        public static void Seed(IApplicationBuilder app)
        {
            ...
            var users = new List<User>() { 
                new User(){Username="usera",Email="usera@gmail.com",Password="1234",ImageUrl="user1.jpg"},
                new User(){Username="userb",Email="userb@gmail.com",Password="1234",ImageUrl="user2.jpg"},
                new User(){Username="userc",Email="userc@gmail.com",Password="1234",ImageUrl="user3.jpg"}
            ...
            {
                new Cast(){Movie=movies[0],Person=people[0],Name="Oyuncu adı 1",Character="Karakter"},
